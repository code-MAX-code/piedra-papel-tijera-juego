...
3. Haz doble clic en el archivo `piedra-papel-tijera-juego.pyw` para iniciar la aplicación.
...
- Puedes usar el botón **Reiniciar Marcador** para volver a empezar desde cero.

## Utilizado
- **Python**: Lógica del juego.
